...
const DefectsListBoxMy = (props) => (
        ...
        <Pagination counts={props.items.count} path={`${props.hostEnable ? '' : '/' + props.community.get('slug')}/cabinet/my-defects/`} matched={props.url} limits={25} />
      </div>
		)

export default connect(mapStateToProps)(DefectsListBoxMy);
